...
import { HasRefreshedAuthToken } from "../utils/auth";
...
export default function SMFPEForm() {
  ...
  React.useEffect(() => {
    // If you want to call an async function here, and not return a Promise,
    // this is what they make you do.
    const getRefreshToken = async () => {
      const isAuthenticated = await HasRefreshedAuthToken();
      setAuthenticated(isAuthenticated);
    }

    const isRefreshed = getRefreshToken();
    console.log("Refresh token response value is: ", isRefreshed);
