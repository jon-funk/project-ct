...
import MFPEModifyForm from "../../components/modify_form";
    ...
    React.useEffect(() => {
        async function fetchPatientEncounters() {
            ...
            if (Array.isArray(patientEncounters)) {
                ...
                setErrorMessage("Unable to load data from the server. Try refreshing and if the problem persists, contact the development team");
    ...
    if (isError) {
        return (
            <>
                ...
                {
                    isError && (
                        <Typography variant="h4" component="h4" sx={{ pt: "2rem", margin: "2rem", textAlign: "center", fontWeight: "bold" }}>
                            {errorMessage}
                        </Typography>
                    )
                }
                ...
                <Container>
                    ...
                    >
                        ...
                        </AppBar>
                        {
                            ...
                            openDialog && <MFPEModifyForm formUUID={formUUID} rowData={selectedRow} />
                        }
                    </Dialog>
                </Container>
            </>
